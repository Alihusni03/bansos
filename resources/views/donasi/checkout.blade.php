...
<html lang="en" data-bs-theme="auto">
  ...
  <body>
      <div class="d-flex flex-wrap flex-md-nowrap align-items-center justify-content-center pt-3 pb-2 mb-3 border-bottom">
        <!-- <a href="/dashboard/pantiasuhan" class="btn btn-success me-3"><span data-feather="arrow-left"></span></a> -->
      ...
      <button class="btn btn-primary" id="pay-button">bayar sekrang</button>
