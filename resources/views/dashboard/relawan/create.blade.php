@extends('dashboard.layouts.main')
    ...
    @section('container')
      <div class="d-flex flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <h1 class="h2">Tambah Data Relawan</h1>
      </div>
      <div class="col-lg-12">
          <form method="post" action="/dashboard/relawan" enctype="multipart/form-data">
            @csrf
            <div class="d-flex">
                <div class="col-md-6 p-2">
                    ...
                    <div class="mb-3 d-flex">
                        ...
                        <div class="ms-4 col-md-3">
                            ...
                            <input type="date" class="form-control @error('tl') is-invalid @enderror " id="tl" name="tl" value="{{ old('tl') }}" required>
                            @error('tl')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="col-md-6 p-2">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('np') is-invalid @enderror " id="np" name="np" required autofocus value="{{ old('np') }}">
                        @error('np')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nowa') is-invalid @enderror " id="nowa" name="nowa" required autofocus value="{{ old('nowa') }}">
                        @error('nowa')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
