@extends('dashboard.layouts.main')
    ...
    @section('container')
      <div class="d-flex flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <h1 class="h2">Tambah Data Anak</h1>
      </div>
      <div class="col-lg-12">
          <form method="post" action="/dashboard/anak" enctype="multipart/form-data">
            @csrf
            <div class="d-flex">
                <div class="col-md-6 p-2">
                    <div class="mb-3">
                        <label for="name" class="form-label">Nama Lengkap</label>
                        <input type="text" class="form-control @error('nama') is-invalid @enderror " id="name" name="name" required autofocus value="{{ old('name')}}">
                        @error('name')
                ...
                <div class="col-md-6 p-2">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('sekolah') is-invalid @enderror " id="sekolah" name="sekolah" required autofocus value="{{ old('sekolah') }}">
                        @error('sekolah')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
