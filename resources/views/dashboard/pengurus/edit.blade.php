            ...
            <div class="d-flex">
                <div class="col-md-6 p-2">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nama') is-invalid @enderror " id="nama" name="nama" required autofocus value="{{ old('nama', $pengurus->nama)}}">
                        @error('nama')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="hidden" name="oldFoto" value="{{ $pengurus->foto }}">
                        @if($pengurus->foto)
                            <img src="{{ asset('storage/' . $pengurus->foto) }}" id="preview" class="img-thumbnail" style="max-width: 200px; max-height: 200px;">
                        @else
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('jabatan') is-invalid @enderror " id="jabatan" name="jabatan" required autofocus value="{{ old('jabatan',$pengurus->jabatan) }}">
                        @error('jabatan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
